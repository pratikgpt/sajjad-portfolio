...
/**
 * Brand logos (GitHub, LinkedIn) as inline SVGs.
 * lucide-react no longer ships brand marks, so we provide our own.
 * They use `currentColor` and accept className for sizing/coloring,
 * matching the lucide icon API used elsewhere.
 */
